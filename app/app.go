...
func New(
	...
	*/
	...
	app.DukeKeeper = *dukemodulekeeper.NewKeeper(
		appCodec,
		keys[dukemoduletypes.StoreKey],
		keys[dukemoduletypes.MemStoreKey],
		app.GetSubspace(dukemoduletypes.ModuleName),
	)
